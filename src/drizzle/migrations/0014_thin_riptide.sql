...
DO $$ BEGIN
 ALTER TABLE "advertisements" ADD CONSTRAINT "advertisements_created_by_vendor_profiles_vendor_id_fk" FOREIGN KEY ("created_by") REFERENCES "public"."vendor_profiles"("vendor_id") ON DELETE no action ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
