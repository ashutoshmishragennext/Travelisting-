...
import { ChevronLeft, ChevronRight, Store, Briefcase, Package, X, CheckCircle } from 'lucide-react';
import VendorPreview from '@/components/shared/vendor/VendorPreview';
...
import ServicesInfo from '@/components/vendorpage/ServiceInfo';
import VendorProductForm from '@/components/vendorpage/ProductPage';
import OpningDay from '@/components/vendorpage/Bussinusday';
import { useCurrentUser } from '@/hooks/auth';
import ContactInfo from '@/components/vendorpage/ContactWithPramps';
import Navigation from '@/components/pages/Navbar';
import Footer from '@/components/Footer';
import ContactInfo1 from '@/components/BussinusDay';
// import ContactInfo from '@/components/BussinusDay';
...
const VendorRegistrationForm = ({ params }: { params: { id: string } }) => {
...
const steps: StepType[] = [
  ...
  { component: ContactInfo1, title: 'Contact Information', img: '/basic2.gif' },
  // { component: () => {
  //   if (showOptionsStep) {
  //     return (
