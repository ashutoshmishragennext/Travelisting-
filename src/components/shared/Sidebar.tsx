...
const Sidebar: React.FC<SidebarProps> = ({ items, setActiveComponent }) => {
  ...
  return (
    <aside className="flex h-screen w-56 flex-col overflow-y-auto border-r bg-white px-5 py-2">
      <div className="text-black flex justify-center text-xl m-3 -ml-0.5">
      <Link href={'/'}>
      ...
      {/* <Image
                  ...
                  <h1 className="font-bold text-[45px] ml-1 text-red-500">Blogify</h1>
                  </div>
                  </Link>
      </div>
