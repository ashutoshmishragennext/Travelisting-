  ...
  const features = [
    {
      ...
      description:
        "Upload and promote your best travel packages directly to other travel professionals.",
    },
    {
      icon: <Briefcase className="h-6 w-6 text-primary" />,
      title: "Targeted Advertisements",
      description:
        "Create and manage ads specifically designed for the B2B travel market.",
    },
    {
      icon: <MessageSquare className="h-6 w-6 text-primary" />,
      title: "Direct Communication",
      description:
        "Connect directly with potential partners and generate quality leads.",
    },
    {
      icon: <Shield className="h-6 w-6 text-primary" />,
      title: "Exclusive Network",
      description:
        "Access a secure platform exclusively for verified travel agents.",
    },
  ];
    ...
    <div className="flex flex-col min-h-screen">
          ...
          <div className="flex flex-col-reverse lg:flex-row items-center">
            ...
            <div className="lg:w-1/2 lg:pr-12 mt-10 lg:mt-0">
              <h1 className="text-4xl md:text-5xl font-bold text-gray-900 leading-tight">
                The Ultimate B2B Platform for{" "}
                <span className="text-primary">Travel Agents</span>
              </h1>
              <p className="mt-4 text-lg text-gray-600">
                Connect with other travel professionals, showcase your deals,
                and grow your business network. Exclusively designed for travel
                agents.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="mt-4 text-lg text-gray-600 max-w-2xl mx-auto">
              Everything you need to showcase your offerings and connect with
              other travel agents.
            </p>
          </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900">
              How Travelisting Works
            </h2>
            <p className="mt-4 text-lg text-gray-600 max-w-2xl mx-auto">
              Get started in just three simple steps and begin growing your
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="mt-4 text-lg text-gray-600 max-w-2xl mx-auto">
              Hear what other travel agents are saying about their experience
              with Travelisting.
            </p>
          </div>
        ...
        <div className="container mx-auto px-4">
                  ...
                  <nav className="list-none mb-10">
                    <li className="mb-2">
                      <a
                        ...
                        className="text-gray-600 hover:text-gray-800"
                      >
                        India: +91-78400 79095
                      </a>
                    </li>
                    <li className="mb-2">
                      <a
                        href="tel:+911204994499"
                        className="text-gray-600 hover:text-gray-800"
                      >
                        India: +91-120-4994499
                      </a>
                    </li>
                    <li className="mb-2">
                      <a
                        href="mailto:info@gennextit.com"
                        className="text-gray-600 hover:text-gray-800"
                      >
                        info@gennextit.com
                      </a>
                  ...
                  <nav className="list-none mb-10">
                    <li className="mb-2">
                      <p className="text-gray-600">
                        Basement (C-001), Building H-53
                      </p>
                    </li>
                    <li className="mb-2">
                      <p className="text-gray-600">
                        Sector 63, Noida (UP)-201305, India
                      </p>
                    </li>
                  </nav>
                </div>
          ...
          <div className="border-t border-gray-200 mt-6 pt-6">
            <p className="text-sm text-gray-500 text-center">
              © {new Date().getFullYear()} Travelisting. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
